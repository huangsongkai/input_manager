...
var _htmlReactParser = __webpack_require__(445);
...
var _components = {
  CustomContentLayout: {
    displayName: 'CustomContentLayout'
  }
};

var _DReactNewProjectVersion10Node_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
  filename: 'D:/react/newProjectVersion1.0/components/util/CustomContentLayout.js',
...
var CustomContentLayout = _wrapComponent('CustomContentLayout')(function (_React$Component) {
  _inherits(CustomContentLayout, _React$Component);

  function CustomContentLayout(props) {
    _classCallCheck(this, CustomContentLayout);

    var _this = _possibleConstructorReturn(this, (CustomContentLayout.__proto__ || Object.getPrototypeOf(CustomContentLayout)).call(this, props));
  ...
  _createClass(CustomContentLayout, [{
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            (0, _htmlReactParser2.default)(this.props.content)
          )
        )
      );
    }
...
if (document.getElementById("layout")) ReactDOM.render(React.createElement(CustomContentLayout, _extends({}, pageParas, { navTree: navTree })), document.getElementById("layout"));
exports.default = CustomContentLayout;
 ...
 * Module dependencies.
 */
var utilities = __webpack_require__(199);
 ...
 * Module dependencies.
 */
var domparser = __webpack_require__(443);
var utilities = __webpack_require__(199);
 ...
 * Module dependencies.
 */
var domToReact = __webpack_require__(447);
var htmlToDOM = __webpack_require__(444);
 ...
 * Module dependencies.
 */
var utilities = __webpack_require__(200);
var propertyConfig = __webpack_require__(448);
...
var attributesToProps = __webpack_require__(446);
...
var factory = __webpack_require__(451);
...
var _prodInvariant = __webpack_require__(455);
...
var DOMProperty = __webpack_require__(452);
...
var ReactDOMFactories = __webpack_require__(460);
var ReactElement = __webpack_require__(39);
var ReactPropTypes = __webpack_require__(462);
var ReactVersion = __webpack_require__(464);

var createReactClass = __webpack_require__(466);
...
var PooledClass = __webpack_require__(457);
var ReactElement = __webpack_require__(39);
...
var ReactPropTypeLocationNames = __webpack_require__(461);
...
var ReactNoopUpdateQueue = __webpack_require__(205);
var factory = __webpack_require__(442);
...
var _CustomContentLayout = __webpack_require__(440);

var _CustomContentLayout2 = _interopRequireDefault(_CustomContentLayout);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (document.getElementById("layout")) ReactDOM.render(React.createElement(_CustomContentLayout2.default, pageParas), document.getElementById("layout"));
